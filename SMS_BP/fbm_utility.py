...
def get_fbm_sample(l=1, h=0.5, d=1, n=1):
    ...
    if not isinstance(l, (float, int)):
        raise TypeError(
            "Please enter a valid type for length parameter, you entered: ", type(l))
    if not isinstance(h, (float, int)):
        raise TypeError(
            "Please enter a valid type for hurst parameter, you entered: ", type(h))
    if not isinstance(d, int):
        raise TypeError(
            "Please enter a valid type for dimensions parameter, you entered: ", type(d))
    if not isinstance(n, (float, int)):
        raise TypeError(
            "Please enter a valid type for intervals parameter, you entered: ", type(n))
    if l < 1:
        raise ValueError(
            "Please enter a valid value for length parameter, you entered: ", l)
    if h < 0 or h > 1:
        raise ValueError(
            "Please enter a valid value for hurst parameter, you entered: ", h)
    if d < 1:
        raise ValueError(
            "Please enter a valid value for dimensions parameter, you entered: ", d)
    if n < 1:
        raise ValueError(
            "Please enter a valid value for intervals parameter, you entered: ", n)
